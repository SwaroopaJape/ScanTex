...
Expanding the pipeline leverages large-scale programmatically generated synthetic equations to guarantee syntactical coverage, followed by fine-tuning on scraped real-world examples from sources like arXiv to handle authentic noise and formatting artifacts.
